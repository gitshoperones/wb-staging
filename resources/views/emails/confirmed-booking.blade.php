	...
	<table class="container header" style="padding: 15px; max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);border-bottom: 1px solid #f1f1f1;">
		...
		<tr>
			<td style="text-align: left;">
				...
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					You have a new confirmed booking! {{ $couple->title }} have made payment on your invoice, and the booking is now locked in. Be sure to add this to your calendar and start preparing.
				</p>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: left;">
					<a href="{{ url('/dashboard') }}" class="btn orange" style="font-family: 'Ubuntu', sans-serif;text-decoration: none;text-transform: uppercase;font-size: 14px;font-weight: 300;border-radius: 3px;padding: 11px 48px;background: #fe5e44;display: inline-block;color: #fff;">Login to view this booking
					</a>
				</td>
			</tr>
			<tr>
				<td style="text-align: left;">
					<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">Kind regards,</p>
