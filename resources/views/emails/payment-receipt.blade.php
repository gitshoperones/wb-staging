		...
		<tr>
			<td style="text-align: left;">
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					You have made payment to {{ $data['businessName'] }} for your {{ $data['jobCategory'] }} booking.
				</p>
			</td>
		</tr>
		...
		<tr>
			<td style="text-align: left; background-color: #e7d8d1; font-size: 14px;">
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Total Booking Amount: ${{ number_format($data['totalInvoice'], 2) }}
				</span>
				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Amount Paid: ${{ number_format($data['amountPaid'], 2) }}
				</span>

				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Total Still Owing: ${{ number_format($data['balance'], 2) }}
				</span>
			</td>
		</tr>
		<tr>
