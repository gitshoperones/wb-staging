...
<head>
	...
	<title>wedBooker - confirm email</title>
	<style>
		/* cyrillic-ext */
		@font-face {
			font-family: 'Ubuntu';
	...
	<table class="container header" style="padding: 15px; max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);border-bottom: 1px solid #f1f1f1;">
		...
		<tr>
			<td style="text-align: left;">
				...
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">Thank you for booking {{ $vendorTitle }} through wedBooker. We pride ourselves on maintaing a professional community of Wedding Suppliers & Venues, and therefore value the feedback we receive from our Couples.</p>

				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">Please leave a quick review to let us know how you enjoyed working with {{ $vendorTitle }}. It only takes 2 minutes!</p>
				</td>
			</tr>
			<tr>
				<td style="height: 20px; font-family: 'Ubuntu', sans-serif;"></td>
			...
			<tr>
				<td style="text-align: left;">
					<a href="{{ url(sprintf('/vendor-review/%s?job-quote-id=%s', $code, $jobQuoteId)) }}" class="btn orange" style="font-family: 'Ubuntu', sans-serif;text-decoration: none;text-transform: uppercase;font-size: 14px;font-weight: 300;border-radius: 3px;padding: 11px 48px;background: #fe5e44;display: inline-block;color: #fff;">Click here to review them now
					</a>
				</td>
			</tr>
			...
			<tr>
				<td style="text-align: left;">
					<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">We hope you had a fantastic day!</p>
					<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">All the best,</p>
