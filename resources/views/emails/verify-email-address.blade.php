	...
	<table class="container header" style="padding: 15px; max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);border-bottom: 1px solid #f1f1f1;">
		...
		<tr>
			<td style="text-align: left;">
				...
				Thanks for signing up with wedBooker. Click the link below to verify your email address.
				</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align: left;">
				<a href="{{ $link }}" class="btn orange" style="font-family: 'Ubuntu', sans-serif;text-decoration: none;text-transform: uppercase;font-size: 14px;font-weight: 300;border-radius: 3px;padding: 11px 48px;background: #fe5e44;display: inline-block;color: #fff;">Verify Email
				</a>
			</td>
		</tr>
	</table>
