...
<head>
	...
	<title>wedBooker - REMITTANCE ADVICE</title>
	<style>
		/* cyrillic-ext */
		@font-face {
			font-family: 'Ubuntu';
		...
		<tr>
			<td style="text-align: left;">
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					You have received a payment from {{ $data['coupleName'] }}.
				</p>
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					<a style="color: #FE5945;" href="{{ url(sprintf('/invoice/%s/pdf', $data['invoiceId'])) }}">Download Copy Of Invoice</a>
				</p>
			</td>
		</tr>
		...
		<tr>
			<td style="text-align: left; background-color: #e7d8d1; font-size: 14px;">
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Total Booking Amount: <b>$ {{ number_format($data['totalInvoice'], 2) }}</b>
				</span>
				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Payment Received: <b>$ {{ number_format($data['paymentSent'], 2) }}</b>
				</span>
				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					WedBooker Fee: <b>$ {{ number_format($data['fee'], 2) }}</b>
				</span>
				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Amount You Receive: <b>$ {{ number_format($data['amountReceived'], 2) }}</b>
				</span>
				<hr style="margin: 0;" />
				<span style="padding: 5px; display: block; font-family: 'Ubuntu'; color: #353554; font-size: 14px;">
					Still Owing: <b>$ {{ number_format($data['balance'], 2) }}</b>
				</span>
			</td>
		</tr>
		<tr>
			<td style="text-align: left;">
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					This will be paid into your nominated bank account. To update your bank details, you can login to <a style="color: #FE5945;" href="{{ url('/') }}">wedBooker.com</a>  and access your business settings, or contact us at <a style="color: #FE5945;" href="mailto: hello@wedbooker.com ">hello@wedbooker.com </a>
				</p>
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					Kind regards, <br />
					The wedBooker Team
