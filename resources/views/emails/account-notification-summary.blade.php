...
<head>
	...
	<title>{{ isset($notification['title']) ? $notification['title'] : 'wedBooker' }}</title>
	<style>
...
<body style="background-color: #e7d8d1;padding: 60px 15px;text-align: center;font-weight: 300;font-family: 'Ubuntu', sans-serif;line-height: 1.6em;">
	<table class="container header" style="max-width: 600px; padding: 15px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);">
		<tr>
			<td>
				...
				<table class="fullwidth" style="width: 100%; text-align: left;">
					<tr>
						<td>{!! isset($notification['body']) ? $notification['body'] : '<p style="font-family: \'Ubuntu\', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">Login to your wedBooker account to view <a style=\'color:#373654; font-size: 14px;\'>today\'s</a> activity.</p>' !!}</td>
					</tr>
				</table>
			</td>
			<td style="height: 15px;"> </td>
		...
		<td style="text-align: left;">
			<a href="{{ (isset($notification['btnLink'])) ? url($notification['btnLink']) : url('/dashboard') }}" class="btn orange" style="font-family: 'Ubuntu', sans-serif;text-decoration: none;text-transform: uppercase;font-size: 14px;font-weight: 300;border-radius: 3px;padding: 11px 48px;background: #fe5e44;display: inline-block;color: #fff;">{{ isset($notification['btnTxt']) ? $notification['btnTxt'] : 'Login To My wedBooker Account' }}</a>
		</td>
	</tr>
	<tr>
...
<!-- /.container -->
<table class="container fullwidth center bg-white" style="padding: 15px; max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;text-align: center;">
	<tr>
