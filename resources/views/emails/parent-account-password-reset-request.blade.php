...
<head>
	...
	<title>wedBooker - reset password</title>
	<style>
		/* cyrillic-ext */
		@font-face {
			font-family: 'Ubuntu';
...
<body style="background-color: #e7d8d1;padding: 60px 15px;text-align: center;font-weight: 300;font-family: 'Ubuntu', sans-serif;line-height: 1.6em;">
	<table class="container header" style="max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);border-bottom: 1px solid #f1f1f1;">
		<tr>
			<td>
		...
		<tr>
			<td>
				<p style="font-family: 'Ubuntu', sans-serif;text-decoration: none;color: #353554; font-size: 14px;">
					Your {{ $businessName }} wedBooker account has been created. Please click the link below to set your password for this account.
				</p>
			</td>
		</tr>
		<tr>
			<td>
				<a href="{{ $link }}" class="btn orange" style="font-family: 'Ubuntu', sans-serif;text-decoration: none;text-transform: uppercase;font-size: 14px;font-weight: 300;border-radius: 3px;padding: 11px 48px;background: #fe5e44;display: inline-block;color: #fff;">Set My Password</a>
			</td>
		</tr>
	</table>
	...
	<table class="container fullwidth center bg-white" style="max-width: 600px; margin: auto;background-color: #fff;width: 100%;margin: auto;-webkit-box-shadow: 0 0 3px 0 rgba(0,0,0,.1);box-shadow: 0 0 3px 0 rgba(0,0,0,.1);text-align: center;">
		<tr>
			<td style="height: 20px;"></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="social">
				<table class="fullwidth center" style="width: 100%;text-align: center;">
					<tr>
						<td>
							<a href="https://www.facebook.com/WedBooker/" target="_blank" style="text-decoration: none;padding: 7px;">
		...
		<tr>
			<td class="font-sm" style="font-size: 14px;">
				<p style="color: #434343; font-family: 'Ubuntu', sans-serif;">Copyright &copy; {{ now()->year }} wedBooker Pty Ltd All Rights Reserved.</p>
			</td>
		</tr>
		<tr>
			<td class="font-sm center" style="text-align: center;font-size: 14px;">
				<p style="max-width: 500px; margin: auto; color: #434343; font-family: 'Ubuntu', sans-serif;">You are receiving this email because you have signed-up to <a href="{{ url('/') }}" style="color: #fe5e44;">wedBooker.com</a>. 
				</p>
			</td>
		</td>
		<tr>
		...
		<tr>
			<td class="footer-menu font-sm" style="font-size: 14px;">
