	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-7">
				...
				<form method="POST" action="{{ url('/dashboard/job-quotes') }}"
				enctype="multipart/form-data"
				autocomplete="off">
				{{ csrf_field() }}
				<input type="hidden" name="job_post_id" value="{{ request('job_post_id') }}">
				<div class="wb-box wb-tab-send-quote">
					@include('partials.alert-messages')
					...
					<ul class="nav nav-tabs">
                        ...
                        <li>
							<a href="#tab_step_4" onClick="resetStepTo(4)" id="cc-quote-tab-4" data-toggle="tab">Step 4</a>
						</li>
					</ul>
